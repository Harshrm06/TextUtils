...
export default function About(props) {
 ...
 let myStyle = {
  ...
  backgroundColor : props.mode=== 'dark' ? '#000000e2':'white',
        ...
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body" style={myStyle}>
              ...
              for a given text.TextUtils reports the number of words and characters.Thus is is suitable for writing text with word
              /character limit.
            </div>
          </div>
        </div>
